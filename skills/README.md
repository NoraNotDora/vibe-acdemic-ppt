...
This folder contains the local skills used by the academic PPT workflow, plus the reusable markdown templates they depend on.

Canonical instructions live in each skill's `SKILL.md`. The top-level markdown files are supporting templates and reference notes that help keep planning, personalization, and TeX work in sync.
...
## Maintenance Rule
- Update a skill and its support file together when the workflow changes.
- Keep the supporting markdown readable and lightweight so the canonical skill stays easy to trigger.
- If a template becomes outdated, refresh it before adding more deck-specific instructions elsewhere.
